...
$_SESSION['passwordResetTokenTimestamp'] = date('m/d/Y h:i:s a', time());
$_SESSION['passwordResetToken'] = md5($_POST['passwordResetEmail'] . $_SESSION['passwordResetTokenTimestamp']);
...
if ( ! $emailIsValid ) {
	...
	if( TRUE ) {
		...
		$message = "Hello, we received a password reset request for ServiceSwap account. To reset your password, please use the following URL: http://grserviceswap.isys489.com/dev/stephen/ResetPassword.php?passwordResetToken=" . $_SESSION['passwordResetToken'];
