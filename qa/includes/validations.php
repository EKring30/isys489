...
function validate_confirmPassword($newPassword, $confirmNewPassword) 
{
    if (!empty($confirmNewPassword))
    {
        if ($newPassword == $confirmNewPassword) //New Password and the confirmation entry match
        {
            return TRUE; // True = Good: Confirmation entry matches password entry
        }
        else 
        {
            return FALSE; // False = Bad: Password confirmation doesn't match password
        }
    }
    else
        return FALSE; // False = Bad: Password confirmation is null
}
